...
class ViewStocksPage extends StatefulWidget {
  @override
  _ViewStocksPageState createState() => _ViewStocksPageState();
}

class _ViewStocksPageState extends State<ViewStocksPage> {
